...
You can find example_table.csv [here](https://github.com/gustaveroussy/training_bigr/blob/main/Introduction_R_RStudio/example_table.csv)(download it by clocking on the "Download raw file" button).
