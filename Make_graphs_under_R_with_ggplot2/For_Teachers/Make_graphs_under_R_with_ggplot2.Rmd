...
We can adjust the number of bins or their width with `bins` and `binwidth` parameters. We can also manually set the `breaks`.
```{r}
...
*Exercice :*  
Draw a violinplot on the "Age" and "Sex" of the clinical_data dataset, with values too (shape and points).
